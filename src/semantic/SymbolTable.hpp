...
struct TabEntry {
    ...
    TabEntry()
        : id(""), link(0), obj(0), type(0), ref(0), nrm(1), lev(0), adr(0) {}

    TabEntry(const std::string &name, int l, int o, int t, int r, int n, int lv,
             int a)
...
struct ATabEntry {
    ...
    ATabEntry()
        : xtyp(0), etyp(0), eref(0), low(0), high(0), elsz(0), size(0) {}
