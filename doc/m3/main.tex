...
\begin{figure}[H]
\centering
\fbox{\parbox{0.8\textwidth}{\centering\vspace{2cm}Ilustrasi hubungan antara Parse Tree, AST, dan Decorated AST\vspace{2cm}}}
...
=== tab (predefined portion) ===
1    integer   3    1    0    1    0    0    0
2    real      3    2    0    1    0    0    1
...
6    true      1    4    0    1    0    1    5
7    false     1    4    0    1    0    0    6
8    writeln   4    0    0    1    0    0    7
9    readln    4    0    0    1    0    0    8
...
...
=== tab (portion) ===
...
12    FuncReturn 3    0    0    1    0    0    11
13    result   2    1    0    1    0    0    12
14    Square   5    1    0    1    0    0    13
15    n        2    1    0    1    1    1    14
...
Semantic error on line 8: Type mismatch in assignment:
  expected Integer, got Real
\end{lstlisting}
...
Semantic error on line 5: Undeclared identifier 'z'
Semantic error on line 5: Type mismatch in assignment:
  expected Integer, got Unknown
Semantic error on line 6: Undeclared identifier 'y'
Semantic error on line 6: Type mismatch in assignment:
  expected Unknown, got Integer
\end{lstlisting}
...
Semantic error on line 6: If condition must be Boolean, got Integer
Semantic error on line 8: While condition must be Boolean, got Integer
\end{lstlisting}
...
Semantic error on line 6: 'not' requires Boolean operand, got Integer
Semantic error on line 7: Logical operator 'and' requires Boolean operands,
  got Integer and Boolean
Semantic error on line 8: Logical operator 'or' requires Boolean operands,
  got Boolean and Integer
\end{lstlisting}
