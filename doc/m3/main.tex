...
Pengujian dilakukan terhadap berbagai kasus masukan untuk memverifikasi kebenaran semantic analyzer dalam melakukan analisis semantik dan pembangunan tabel simbol. Setiap kasus uji dijalankan dengan perintah \texttt{./bin/driver\_m3 <nama\_berkas>}. Keluaran berupa AST, pesan kesalahan semantik (jika ada), dan tabel simbol dibandingkan dengan hasil yang diharapkan.
...
\begin{figure}[H]
\centering
\includegraphics[width=0.95\textwidth]{test1_output.png}
\caption{Output semantic analyzer untuk test case 1 (pos\_basic\_assign.txt)}
\end{figure}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.95\textwidth]{test2_output.png}
\caption{Output semantic analyzer untuk test case 2 (pos\_scope.txt)}
\end{figure}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.95\textwidth]{test3_output.png}
\caption{Output semantic analyzer untuk test case 3 (pos\_array\_record.txt)}
\end{figure}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.95\textwidth]{test4_output.png}
\caption{Output semantic analyzer untuk test case 4 (pos\_predefined.txt)}
\end{figure}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.95\textwidth]{test5_output.png}
\caption{Output semantic analyzer untuk test case 5 (pos\_func\_return.txt)}
\end{figure}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.95\textwidth]{test6_output.png}
\caption{Output semantic analyzer untuk test case 6 (edge\_real\_int\_compat.txt)}
\end{figure}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.95\textwidth]{test7_output.png}
\caption{Output semantic analyzer untuk test case 7 (edge\_scope\_shadow.txt)}
\end{figure}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.95\textwidth]{test8_output.png}
\caption{Output semantic analyzer untuk test case 8 (neg\_undeclared.txt)}
\end{figure}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.95\textwidth]{test9_output.png}
\caption{Output semantic analyzer untuk test case 9 (neg\_bool\_condition.txt)}
\end{figure}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.95\textwidth]{test10_output.png}
\caption{Output semantic analyzer untuk test case 10 (neg\_type\_mismatch.txt)}
\end{figure}
