...
\subsection{Diagram DFA}
Diagram DFA yang dirancang untuk lexer bahasa Arion ditunjukkan pada Gambar~\ref{fig:dfa}.

\begin{figure}[H]
  \centering
  \includegraphics[width=\textwidth]{dfa_diagram.png}
  \caption{Diagram DFA lexer bahasa Arion}
  \label{fig:dfa}
\end{figure}
...
\subsection{Keuntungan Struktur Modular untuk Milestone Selanjutnya}
...
\begin{figure}[H]
  \centering
  \fbox{\parbox{0.7\textwidth}{\centering\vspace{1.5cm}[SCREENSHOT PLACEHOLDER --- Kasus Uji 1]\vspace{1.5cm}}}
...
\begin{figure}[H]
  \centering
  \fbox{\parbox{0.7\textwidth}{\centering\vspace{1.5cm}[SCREENSHOT PLACEHOLDER --- Kasus Uji 2]\vspace{1.5cm}}}
...
\begin{figure}[H]
  \centering
  \fbox{\parbox{0.7\textwidth}{\centering\vspace{1.5cm}[SCREENSHOT PLACEHOLDER --- Kasus Uji 3]\vspace{1.5cm}}}
...
\begin{figure}[H]
  \centering
  \fbox{\parbox{0.7\textwidth}{\centering\vspace{1.5cm}[SCREENSHOT PLACEHOLDER --- Kasus Uji 4]\vspace{1.5cm}}}
...
\begin{figure}[H]
  \centering
  \fbox{\parbox{0.7\textwidth}{\centering\vspace{1.5cm}[SCREENSHOT PLACEHOLDER --- Kasus Uji 5]\vspace{1.5cm}}}
...
\begin{figure}[H]
  \centering
  \fbox{\parbox{0.7\textwidth}{\centering\vspace{1.5cm}[SCREENSHOT PLACEHOLDER --- Kasus Uji 6]\vspace{1.5cm}}}
...
\begin{figure}[H]
  \centering
  \fbox{\parbox{0.7\textwidth}{\centering\vspace{1.5cm}[SCREENSHOT PLACEHOLDER --- Kasus Uji 7]\vspace{1.5cm}}}
...
\begin{enumerate}[label=\arabic*., leftmargin=2em]
  \item Menambahkan dukungan untuk \textit{escape character} dalam literal string (misalnya \texttt{\textbackslash n}, \texttt{\textbackslash t}).
  \item Mengimplementasikan \textit{error recovery} yang lebih canggih, misalnya dengan \textit{panic mode} yang mencoba menyinkronisasi kembali pada titik koma atau kata kunci berikutnya.
  \item Menambahkan informasi kolom (selain baris) pada struktur \texttt{Token} untuk pelaporan kesalahan yang lebih presisi.
  \item Mempertimbangkan penggunaan tabel transisi DFA yang dibangkitkan secara otomatis dari spesifikasi ekspresi reguler untuk meningkatkan maintainabilitas.
\end{enumerate}
...
\textbf{Peran:} \\
\textbf{Refleksi:} [Diisi oleh anggota]
