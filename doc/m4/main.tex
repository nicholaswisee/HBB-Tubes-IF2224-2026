...
\begin{figure}[H]
\centering
\includegraphics[width=0.9\textwidth]{testcase_basic.png}
\caption{Hasil pengujian kasus uji basic}
\end{figure}

\textbf{Analisis:} \textit{[Isi analisis di sini]}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.9\textwidth]{testcase_arith.png}
\caption{Hasil pengujian kasus uji aritmetika}
\end{figure}
...
\textbf{Masukan:} \textit{[Isi source code di sini]}

\textbf{Keluaran yang diharapkan:} \textit{[Isi output di sini]}

\begin{figure}[H]
\centering
\includegraphics[width=0.9\textwidth]{testcase_if_else.png}
\caption{Hasil pengujian kasus uji if-else}
\end{figure}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.9\textwidth]{testcase_while.png}
\caption{Hasil pengujian kasus uji while}
\end{figure}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.9\textwidth]{testcase_for.png}
\caption{Hasil pengujian kasus uji for}
\end{figure}

\textbf{Analisis:} \textit{[Isi analisis di sini]}

% Optional: Kasus uji tambahan

\subsubsection{Kasus Uji 6: Negatif -- Division by Zero}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.9\textwidth]{testcase_divzero.png}
\caption{Hasil pengujian kasus uji division by zero}
\end{figure}
...
\textit{[Isi dengan bonus yang berhasil diimplementasikan, misalnya:]}

\begin{enumerate}
    \item \textbf{Stack Overflow} ... \textit{[deskripsi]}
    \item \textbf{Stack Underflow} ... \textit{[deskripsi]}
    \item \textbf{Invalid Jump Target} ... \textit{[deskripsi]}
    \item \textbf{Out-of-Bounds Access} ... \textit{[deskripsi]}
    \item \textbf{Numerical Overflow} ... \textit{[deskripsi]}
    \item \textbf{Stack Smashing} ... \textit{[deskripsi]}
\end{enumerate}
